...
export const noticeContentSample = [
  {
    category: "공지사항",
    items: [
      {
        title: "운영 정책 변경 안내",
        content: "서비스 이용과 관련된 운영 정책이 변경되었습니다. 변경된 내용을 확인해 주세요.",
      },
      {
        title: "고객 지원 센터 운영 시간 변경",
        content: "고객 지원 센터의 운영 시간이 조정되었습니다. 자세한 사항은 공지 내용을 참고해 주세요.",
      },
      {
        title: "회원 등급 및 혜택 조정 안내",
        content: "회원 등급별 혜택이 새롭게 조정되었습니다. 달라진 혜택을 확인해 보세요.",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "출석 체크 이벤트 진행",
        content: "매일 출석 체크하고 특별한 혜택을 받아보세요! 이벤트 기간 동안 다양한 보상이 제공됩니다.",
      },
      {
        title: "친구 초대 프로모션",
        content: "친구를 초대하면 보너스 포인트를 받을 수 있는 특별 프로모션을 진행합니다.",
      },
      {
        title: "신규 회원 웰컴 이벤트",
        content: "신규 가입 회원을 대상으로 특별한 혜택을 제공합니다. 이벤트 기간을 놓치지 마세요!",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "새로운 기능 추가 안내",
        content: "사용자의 편의를 위해 새로운 기능이 추가되었습니다. 상세 내용은 업데이트 내용을 확인하세요.",
      },
      {
        title: "버그 수정 및 성능 개선",
        content: "서비스 안정성을 높이기 위해 여러 가지 버그 수정과 성능 최적화가 이루어졌습니다.",
      },
      {
        title: "모바일 앱 디자인 개편",
        content: "더 나은 사용자 경험을 위해 모바일 앱 UI가 새롭게 변경되었습니다.",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "서비스 이용 꿀팁 안내",
        content: "서비스를 더욱 효과적으로 이용하는 다양한 꿀팁을 공유합니다!",
      },
      {
        title: "자주 묻는 질문(FAQ) 업데이트",
        content: "자주 묻는 질문이 새롭게 정리되었습니다. 궁금한 사항을 더욱 쉽게 찾아보세요.",
      },
      {
        title: "커뮤니티 가이드라인 안내",
        content: "건강한 커뮤니티 문화를 위해 가이드라인을 업데이트했습니다. 모두가 즐길 수 있는 공간을 만들어가요!",
      },
    ],
  },
];
