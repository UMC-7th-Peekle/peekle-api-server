...
(
    ...
    created_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null,
    updated_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint chats_chatroom_chatroom_id_fk2
...
(
    ...
    created_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null,
    updated_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint chats_chats_chat_id_fk
        foreign key (parent_chat_id) references peekling_chats (chat_id)
            on update cascade on delete set null,
    constraint chats_peekling_chatroom_peekling_id_fk
        foreign key (chatroom_id) references peekling_chatroom (peekling_id)
            on update cascade on delete cascade,
...
(
    ...
    created_at timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint chat_images_chats_chat_id_fk
        foreign key (chat_id) references peekling_chats (chat_id)
);

alter table peekling_chatroom
    add constraint peekling_chatroom_chats_chat_id_fk
