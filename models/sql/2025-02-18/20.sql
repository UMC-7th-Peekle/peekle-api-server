...
(
    ...
    constraint role_hierarchy_roles_role_id_fk
        foreign key (child_role_id) references roles (role_id)
            on update cascade on delete cascade,
    constraint role_hierarchy_roles_role_id_fk_2
...
(
    ...
    author_id         bigint unsigned                           null,
    is_anonymous      bigint unsigned                           not null,
...
(
    article_image_id bigint unsigned auto_increment
        primary key,
    article_id       bigint unsigned                           not null,
...
(
    article_likes_id bigint unsigned auto_increment
        primary key,
    article_id       bigint unsigned                           not null,
    liked_user_id    bigint unsigned                           not null,
    created_at       timestamp(6) default CURRENT_TIMESTAMP(6) not null,
...
(
    chatroom_id           bigint unsigned auto_increment
        primary key,
    sender_id             bigint unsigned                           null,
    receiver_id           bigint unsigned                           null,
    is_sender_anonymous   tinyint(1)                                not null,
    is_receiver_anonymous tinyint(1)                                not null,
    name                  varchar(30)                               not null,
    notice_chat_id        bigint unsigned                           null,
    created_at            timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at            timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint chatroom_users_user_id_fk
        foreign key (sender_id) references users (user_id)
            on update set null on delete set null,
    constraint chatroom_users_user_id_fk_2
...
(
    ...
    parent_chat_id bigint unsigned                                                   null,
    status         enum ('active', 'edited', 'deleted') default 'active'             not null,
    author_id      bigint unsigned                                                   null,
    type           enum ('text', 'image')                                            not null,
    content        varchar(1000)                                                     null,
    created_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null,
    updated_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint chats_chatroom_chatroom_id_fk
...
(
    ...
    created_at timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint chat_images_chats_chat_id_fk2
        foreign key (chat_id) references chats (chat_id)
);

alter table chatroom
    add constraint chatroom_chats_chat_id_fk
        foreign key (notice_chat_id) references chats (chat_id)
            on update cascade on delete cascade;

create table community_suggestions
(
    suggestion_id bigint unsigned auto_increment
        primary key,
    author_id     bigint unsigned                           null,
    title         varchar(512)                              not null,
    content       text                                      not null,
    created_at    timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at    timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint community_suggestions_users_user_id_fk
        foreign key (author_id) references users (user_id)
            on update cascade on delete set null
);

create index community_suggestions_user_user_id_fk
    on community_suggestions (author_id);
...
(
    ...
    location_group_id bigint unsigned                           null,
...
(
    event_id          bigint unsigned                           not null
        primary key,
    location_group_id bigint unsigned                           not null,
    position          geometry                                  not null,
    road_address      varchar(1024)                             not null,
    jibun_address     varchar(1024)                             not null,
    building_code     varchar(100)                              not null,
    building_name     varchar(1024)                             not null,
    sido              varchar(100)                              not null,
    sigungu           varchar(100)                              not null,
    sigungu_code      varchar(100)                              not null,
    roadname_code     varchar(100)                              not null,
    zone_code         varchar(100)                              not null,
    detail            varchar(200)                              null,
    created_at        timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at        timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint event_location_event_location_groups_group_id_fk
        foreign key (location_group_id) references event_location_groups (group_id)
            on update cascade on delete cascade,
    constraint event_location_ibfk_1
        foreign key (event_id) references events (event_id)
            on update cascade on delete cascade
);

create index event_id
    on event_location (event_id);
...
(
    event_scrap_id bigint unsigned auto_increment
        primary key,
    event_id       bigint unsigned                           not null,
...
create index events_event_location_groups_group_id_fk
    on events (location_group_id);
...
(
    notice_id   bigint unsigned auto_increment
        primary key,
    category_id bigint unsigned                           null,
    author_id   bigint unsigned                           null,
    title       varchar(512)                              not null,
...
(
    peekling_id     bigint unsigned auto_increment
        primary key,
    title           varchar(20)                                                           not null,
    description     varchar(1000)                                                         null,
    status          enum ('active', 'canceled', 'completed') default 'active'             not null,
...
create table peekling_chatroom
(
    chatroom_id    bigint unsigned                           not null
        primary key,
    name           varchar(30)                               not null,
    notice_chat_id bigint unsigned                           not null,
    created_at     timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at     timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint peekling_chatroom_peekling_peekling_id_fk
        foreign key (chatroom_id) references peekling (peekling_id)
            on update cascade on delete cascade
);

create table peekling_chats
(
    chat_id        bigint unsigned auto_increment
        primary key,
    chatroom_id    bigint unsigned                                                   not null,
    ...
    created_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null,
    updated_at     timestamp(6)                         default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint peekling_chats_peekling_chatroom_chatroom_id_fk
        foreign key (chatroom_id) references peekling_chatroom (chatroom_id)
            on update cascade on delete cascade,
    constraint peekling_chats_peekling_chats_chat_id_fk
        foreign key (parent_chat_id) references peekling_chats (chat_id)
            on update cascade on delete set null,
    constraint peekling_chats_users_user_id_fk
        foreign key (author_id) references users (user_id)
            on update cascade on delete set null
);

create table peekling_chat_images
(
    chat_id    bigint unsigned                           not null
        primary key,
    image_url  varchar(512)                              not null,
    ...
    created_at timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint peekling_chat_images_peekling_chats_chat_id_fk
        foreign key (chat_id) references peekling_chats (chat_id)
);

alter table peekling_chatroom
    add constraint peekling_chatroom_peekling_chats_chat_id_fk
        foreign key (notice_chat_id) references peekling_chats (chat_id);
...
(
    ...
    image_url   varchar(512)                              not null,
    sequence    int                                       not null,
    peekling_id bigint unsigned                           not null,
    created_at  timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at  timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
...
create table peekling_participants
(
    peekling_id    bigint unsigned                                                    not null,
    participant_id bigint unsigned                                                    not null,
    status         enum ('active', 'canceled', 'kicked') default 'active'             not null,
    is_in_chatroom tinyint(1)                            default 1                    not null,
    cancel_reason  varchar(100)                                                       null,
    kick_reason    varchar(100)                                                       null,
    created_at     timestamp(6)                          default CURRENT_TIMESTAMP(6) not null,
    updated_at     timestamp(6)                          default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    primary key (peekling_id, participant_id),
    constraint peekling_participants_peekling_peekling_id_fk
        foreign key (peekling_id) references peekling (peekling_id),
    constraint peekling_participants_users_user_id_fk
        foreign key (participant_id) references users (user_id)
            on update cascade on delete cascade
);

create table peekling_save
(
    ...
    created_at      timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at      timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint peekling_save_peekling_category_category_id_fk
        foreign key (category_id) references peekling_category (category_id)
            on update cascade on delete set null,
    constraint peekling_save_users_user_id_fk
        foreign key (created_user_id) references users (user_id)
            on update cascade on delete cascade
);
...
(
    report_id        bigint unsigned auto_increment
        primary key,
    type             enum ('user', 'article', 'comment', 'event', 'peekling')        not null,
...
(
    ticket_message_id bigint unsigned auto_increment
        primary key,
...
(
    block_id        bigint unsigned auto_increment
        primary key,
    blocker_user_id bigint unsigned                           not null comment '차단을 하는 사람',
    blocked_user_id bigint unsigned                           not null comment '차단 당한 사람',
...
(
    user_filter_id     bigint unsigned auto_increment
        primary key,
    user_id            bigint unsigned                           not null,
...
(
    user_restriction_id bigint unsigned auto_increment
        primary key,
    user_id             bigint unsigned                                not null,
...
create table user_socket_rooms
(
    user_id    bigint unsigned                           not null,
    ...
    constraint user_socket_rooms_users_user_id_fk
        foreign key (user_id) references users (user_id)
);

create table user_terms
(
    user_terms_id bigint unsigned auto_increment
        primary key,
    user_id       bigint unsigned                           not null,
