...
(
    ...
    constraint chats_chats_chat_id_fk
        foreign key (parent_chat_id) references chats (chat_id)
            on update cascade on delete set null,
...
(
    ...
    road_address      varchar(1024)                             null,
    jibun_address     varchar(1024)                             null,
    building_code     varchar(100)                              null,
    building_name     varchar(1024)                             null,
    sido              varchar(100)                              null,
    sigungu           varchar(100)                              null,
    sigungu_code      varchar(100)                              null,
    roadname_code     varchar(100)                              null,
...
(
    ...
    created_at     timestamp(6) default CURRENT_TIMESTAMP(6) not null,
    updated_at     timestamp(6) default CURRENT_TIMESTAMP(6) not null on update CURRENT_TIMESTAMP(6),
    constraint peekling_chatroom_chats_chat_id_fk
